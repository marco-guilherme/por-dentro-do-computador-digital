  ...
  return (
    <div className="site-content-wrapper">
      ...
      <div className="site-content">
        <p>
          Assembly (às vezes abreviado como asm) é um nome genérico que pode ser
          dado a qualquer linguagem de programação de baixo nível que possua uma
          relação de um para um entre o código de operação da arquitetura e os
          nomes simbólicos. Achou complicado? Pois saiba que no começo é assim
          mesmo, mas depois de alguns anos estudando assembly, parece que você
          ainda está no começo! Brincadeiras a parte, vamos passo a passo.
        </p>
        ...
        <p>
          ...
          como o hardware está organizado é o que define a arquitetura do
          sistema. Cada arquitetura possui seu próprio conjunto de instruções
          (instruction set), que em um nível de abstração mais alto, significa:
          o que aquele processador é capaz de fazer. Vejamos abaixo uma parte do
          conjunto de instruções da arquitetura x86-16 do clássico
          microprocessador da Intel, o 8086:
        </p>

        <div className="site-image letter">
          <img
        ...
        <p>
          ...
          dois valores. Interessante, não? E para aqueles(as) que não conhecem o
          8086, segue uma imagem desse belíssimo microprocessador :)
        </p>
        ...
        <p>
          Um programa é uma sequência lógica de instruções, de forma que, ao ser
          executado pelo hardware, automatiza uma tarefa e/ou produz um
          resultado. Sendo assim, para desenvolver um programa, basta gravar
          todas as instruções desejadas na memória de programa (memória que
          armazena o programa do sistema. O problema é que, cada instrução é
          representada por um grupo de bits, o chamado “código de operação”.
        ...
        <p>
          ...
          conjunto de instruções, os fabricantes definiram e associaram cada
          código de operação a um nome simbólico. O motivo disso é que, é muito
          mais fácil para um ser humano se lembrar de algumas poucas letras do
          que de uma longa e variável cadeia de zeros e uns. Assim que esse
          mapeamento foi concluído, os programadores desenvolveram um programa
          utilitário para converter cada símbolo no seu código binário
          correspondente.
        </p>
        ...
        <p>
          ...
          utilitário converte esse programa em um arquivo binário, onde cada
          byte possui uma instrução correspondente na entrada. O arquivo binário
          pode então ser gravado no hardware, isto é, o programador pode
          carregar o programa no circuito para uma eventual execução. Isso pode
          ser feito em poucos segundos com o auxílio de um dispositivo conhecido
          como gravador.
        </p>
        ...
        <p>
          ...
          computador no modo "bare-metal" (sem nenhum assembler e/ou gravador de
          memória), seria necessário alterar bit a bit de cada byte na memória
          de programa para formar o código da instrução. Isso seria realizado
          com chaves; em seguida, seria necessário alternar entre os endereços
          da memória para gravar as próximas instruções e aplicar os sinais de
          controle corretos no chip para escrever efetivamente cada um dos bits.
          Assim que todo o software estivesse gravado corretamente, bastaria
          iniciar a execução do computador e aguardar a execução do programa.
          Não acredita em mim? Veja um exemplo abaixo retirado do vídeo do Ben
          Eater.
        </p>
        ...
        <p>
          A linguagem assembly (ou linguagem de montagem) é qualquer linguagem
          de programação de baixo nível que possua uma relação muito forte e
          direta entre os mnemônicos e os códigos de operação da arquitetura.
        </p>

        <p>
          Mnemônicos (nomes simbólicos) são palavras curtas (geralmente, com
          três letras) que ajudam o programador a se lembrar de alguma instrução
          do dispositivo. Como vimos anteriormente, a instrução{' '}
          <span className="monospaced-snippet">add</span> é utilizada para somar
          ...
          operação (operation code ou opcode), é uma sequência de bits que
          representa uma instrução e opcionalmente, os dados que serão operados
          por aquela instrução. Do ponto de vista prático, podemos dizer que os
          opcodes da arquitetura são o que o computador realmente entende: uma
          cadeia de zeros e uns. Para entender melhor, vamos utilizar um trecho
          de assembly x86-16 na sintaxe AT&T:
        </p>
        ...
        <p>
          Para começar, tenha em mãos o datasheet (manual) do microprocessador
          Intel 8086. Você pode encontrá-la clicando{' '}
          <a
        ...
        <p>
          ...
          segredo. Como os processadores x86 são máquinas little-endian, o byte
          menos significativo do dado (
        ...
        <p>
          Assumindo que esse programa comece no endereço{' '}
          <span className="monospaced-snippet">0x0100</span>, teríamos a
          seguinte organização na memória:
        </p>
        ...
        <p>
          ...
          específico na memória de programa, pode-se utilizar a instrução “movw”
          do assembly, montar o programa utilizando um assembler e escrever a
          saída no chip de memória utilizando um dispositivo gravador.
        </p>
